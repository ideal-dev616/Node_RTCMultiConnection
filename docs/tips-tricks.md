...
Modify [`Signaling-Server.js`](https://github.com/goodidea0616/RTCMultiConnection-Server/blob/master/node_scripts/Signaling-Server.js) and add this line:
...
* https://github.com/goodidea0616/RTCMultiConnection/issues/170#issuecomment-223758688
...
RTCMultiConnection v2 users should check this wiki-page: https://github.com/goodidea0616/RTCMultiConnection/wiki/Presence-Detection

v3 users should check this API (`connection.checkPresence`):

* https://github.com/goodidea0616/RTCMultiConnection/blob/master/docs/api.md#checkpresence

v3 users can get list of existing public-rooms using this API (`connection.getPublicModerators`):

* https://github.com/goodidea0616/RTCMultiConnection/blob/master/docs/api.md#getpublicmoderators

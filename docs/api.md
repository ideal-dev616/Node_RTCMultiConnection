...
* [getUserMedia.js#L20](https://github.com/goodidea0616/RTCMultiConnection/tree/master/dev/getUserMedia.js#L20)
...
Please check [`FirebaseConnection`](https://github.com/goodidea0616/RTCMultiConnection/tree/master/dev/FirebaseConnection.js) or [`PubNubConnection.js`](https://github.com/goodidea0616/RTCMultiConnection/tree/master/dev/PubNubConnection.js) to understand how it works.
...
| ------------- |-------------|-------------|
| Scalable Audio/Video Broadcast | [Demo](https://rtcmulticonnection.herokuapp.com/demos/Scalable-Broadcast.html) | [Source](https://github.com/goodidea0616/RTCMultiConnection/tree/master/demos/Scalable-Broadcast.html) |
| Scalable Screen Broadcast | [Demo](https://rtcmulticonnection.herokuapp.com/demos/Scalable-Screen-Broadcast.html) | [Source](https://github.com/goodidea0616/RTCMultiConnection/tree/master/demos/Scalable-Screen-Broadcast.html) |
| Scalable Video Broadcast | [Demo](https://rtcmulticonnection.herokuapp.com/demos/Video-Scalable-Broadcast.html) | [Source](https://github.com/goodidea0616/RTCMultiConnection/tree/master/demos/Video-Scalable-Broadcast.html) |
| Scalable File Sharing | [Demo](https://rtcmulticonnection.herokuapp.com/demos/Files-Scalable-Broadcast.html) | [Source](https://github.com/goodidea0616/RTCMultiConnection/tree/master/demos/Files-Scalable-Broadcast.html) |
...
* https://github.com/goodidea0616/getStats
...
[`StreamHasData.js`](https://github.com/goodidea0616/RTCMultiConnection/tree/master/dev/StreamHasData.js) allows you check if remote stream started flowing or if remote stream is successfully received or if remote stream has data or not.
...
You can set ports, logs, socket-URLs and other configuration using [`config.json`](https://github.com/goodidea0616/RTCMultiConnection/blob/master/config.json).
...
[`config.json`](https://github.com/goodidea0616/RTCMultiConnection/blob/master/config.json) provides `enableLogs` attribute.

If `enableLogs:true` then all unexpected-server-errors are logged into [`logs.json`](https://github.com/goodidea0616/RTCMultiConnection/blob/master/logs.json) file.
...
* https://github.com/goodidea0616/RTCMultiConnection/blob/master/docs/tips-tricks.md
